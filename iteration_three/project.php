  ...
  <body>
	...
	<nav>
		<ul class="menu vertical">
			<li><a id="name" href="about.php">Swati Barua</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="small-4 medium-5 large-6 columns">
			    <a href="projects/chatBox.php">
					<img src="img/chatbox.jpg" class="img">
					<figcaption>HTML/CSS | SPRING 2016</figcaption>
				</a>
			</div>
			<div class="small-4 medium-5 large-6 columns">
			    <a href="projects/clubHub.php">
					<img src="img/clubhub-two.jpg" class="img">
					<figcaption>MySQL/PHP | SPRING 2014</figcaption>
				</a>
			</div>
			<div class="small-4 medium-5 large-6 columns">
				<img src="img/Untitled.jpg" class="img">
